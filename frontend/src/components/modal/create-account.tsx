...
export default function CreateAccount({ setShowModal, setRefresh, dataList, setData, user }: CreateAccountProps) {
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-gray-500/50">
        <div className="bg-white rounded-lg min-w-[400px]">
          ...
          <div className='mt-6 mb-6'>
            <FormCreateAccount user={user} setShowModal={setShowModal} setRefresh={setRefresh} dataList={dataList} setData={setData} />
          </div>
